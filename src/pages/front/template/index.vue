<template><div class="q-pa-md" >
    ...
    <q-card class="q-mt-md" >
      <q-table :rows="rows" :columns="columns" hide-pagination="" v-model:selected="selected" selection="multiple" row-key="id" class="" >
        <template v-slot:top="prop" >
          <q-input filled="" dense="" label="名称" class="q-mr-md" v-model="queryForm.name" ></q-input>
          <q-select filled="" dense="" label="可选" class="q-mr-md w-[200px]" map-options="" emit-value="" :options="[{name: &quot;name1&quot;, value: &quot;value1&quot;}, {name: &quot;name2&quot;, value: &quot;value2&quot;}]" option-value="value" option-label="name" v-model="queryForm.select" ></q-select>
        ...
        <template v-slot:body-cell-deletedat="props" >
          <q-td :props="props" >
            ...
            <q-btn v-if="props.row.deletedAt != null" flat="" size="md" style="color: #FF0080" label="恢复" @click="recover(props.row.id)" >
          </q-btn></q-td>
        </template>
      </q-table>

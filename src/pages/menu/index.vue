      ...
      <div>
        <q-table title="Treats" :rows="rows" :columns="columns" row-key="id" :filter="filter" :loading="loading">
          <template v-slot:top>
            ...
            <!-- <q-space /> -->
            <q-input dense filled label="姓名" class="inline-block q-mr-sm" />
            <q-input dense filled label="学号" class="inline-block q-mr-sm" />
            <q-input dense filled label="班级" class="inline-block q-mr-sm" />
            <q-btn flat color="primary" class="inline vertical-top  q-mr-sm" label="" icon="search" @click="loadPage" />
            <q-btn flat color="red" class="inline vertical-top q-mr-sm" label="" icon="restart_alt"
              @click="resetSearch" />
          </template>
